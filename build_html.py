...
<div class="card entrance entrance-d2">
  ...
  <div class="dl-grid">
    <!-- Clash Nodes -->
    <span class="dl-item" id="installBtn" style="cursor:pointer">
      <div class="dl-icon" style="color:#00d4aa">
      ...
      <div class="dl-info">
        <div class="dl-name">Clash Nodes</div>
        <div class="dl-meta">Free proxy subscription &middot; Install to Desktop</div>
      </div>
      <div class="dl-btn" style="background:#00d4aa">Install</div>
    </span>
    <!-- Windows -->
...
document.getElementById('installBtn').addEventListener('click', function() {{
  if (_deferredPrompt) {{
    ...
    _deferredPrompt.userChoice.then(function(r) {{
      if (r.outcome === 'accepted') _deferredPrompt = null;
    }});
  }} else {{
    window.open('https://haonl-7.github.io/clash-nodes/', '_blank');
  }}
}});
</script>
